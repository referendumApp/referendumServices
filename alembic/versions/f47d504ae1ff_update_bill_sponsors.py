...
def upgrade() -> None:
    op.add_column("bill_sponsors", sa.Column("order", sa.String(), nullable=False))
    op.add_column("bill_sponsors", sa.Column("type", sa.String(), nullable=False))
    op.drop_column("bill_sponsors", "is_primary")


def downgrade() -> None:
    op.add_column("bill_sponsors", sa.Column("is_primary", sa.String(), nullable=False))
    op.drop_column("bill_sponsors", "order")
