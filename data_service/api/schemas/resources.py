...
class DenormalizedBill(CamelCaseBaseModel):
    ...
    jurisdiction_id: int = Field(description="Jurisdiction identifier")
    jurisdiction_name: str = Field(description="Name of the jurisdiction")
    level: str = Field(description="Federal or State bill")
